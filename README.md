...
Record audio, upload an audio file, or enter a transcript.
Run transcription if using audio.
Use AI cleaning to generate structured meeting notes.
Review the Summary, Key Decisions, and Action Items.
Copy the notes or export them as a PDF.
📄 PDF Export
